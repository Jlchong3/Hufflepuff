...
dropdown = dcc.Dropdown(['2021-22','2020-21','2019-20','2018-19','2017-18',
                         ...
                         value = '2021-2022' , id = 'Phoenix-players', style={'marginTop':'1vw','marginBottom':'2vw'})

layout = dbc.Container([
    html.Div([
        html.H1('Phoenix Suns')
    ]),
    html.Div([dropdown]),
    html.Div(
        dbc.Table(id = "Suns-table", color = "info", hover = True),
)])

@app.callback(
    Output('Suns-table', 'children'),
    Input('Phoenix-players','value'))
