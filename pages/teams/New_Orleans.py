...
dropdown = dcc.Dropdown(['2021-22','2020-21','2019-20','2018-19','2017-18',
                         ...
                         value = '2021-2022' , id = 'New Orleans-players', style={'marginTop':'1vw','marginBottom':'1vw'})

layout = dbc.Container([
    html.Div([
        html.H1('New Orleans Pelicans')
    ]),
    html.Div([dropdown]),
    html.Div(
        dbc.Table(id = "Pelicans-table"),
)])

@app.callback(
    Output('Pelicans-table', 'children'),
    Input('New Orleans-players','value'))
