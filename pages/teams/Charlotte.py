...
dropdown = dcc.Dropdown(['2021-22','2020-21','2019-20','2018-19','2017-18',
                         ...
                         value = '2021-2022' , id = 'Charlotte-players', style={'marginTop':'1vw','marginBottom':'2vw'})

layout = dbc.Container([
    html.Div([
        html.H1('Charlotte Hornets')
    ]),
    html.Div([dropdown]),
    html.Div(
        dbc.Table(id = "Hornets-table", color = "info", hover = True),
)])

@app.callback(
    Output('Hornets-table', 'children'),
    Input('Charlotte-players','value'))
