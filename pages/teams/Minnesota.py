...
df_2 = df_1[df_1 == 'Minnesota']
df_2.drop(columns=['Tm'])
dropdown = dcc.Dropdown(['2021-2022','2020-2021','2019-2020','2018-2019','2017-2018',
                         '2016-2017','2015-2016','2014-2015','2013-2014','2012-2013',
                         '2011-2012','2010-2011','2009-2010','2008-2009','2007-2008',
                         '2006-2007','2005-2006','2004-2005','2003-2004','2002-2003',
                         '2001-2002', '2000-2001','1999-2000','1998-1999','1997-1998'],
                         value = '2021-2022' , label = 'Seleccione Temporada', id = 'Minnesota-players')

layout = dbc.Container([
    html.Div([
        html.H1('Minnesota Timberwolfs')
    ]),
    html.Div(
        dbc.Table(id = "Timberwolfs-table"),
)])

@app.callback(
    Output('Timberwolfs-table', 'children'),
    Input('Minnesota-players','value'))
def filter_year(value):
    df_year = df_2[value == 'Season']
