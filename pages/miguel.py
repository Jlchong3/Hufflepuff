...
#         html.Div([html.H1("Histórico de relación entre Dribles y Faltas Cometidas"),dcc.Graph(figure=fig)]),
#         html.Br(),

#         html.Div([html.Div([html.H1("Relación de estadísticas por equipo con respecto al tiempo")])]),
#         html.Br(),

#         html.Div([
#             html.Div([html.H2("Estadística 1"), dcc.Dropdown(H, value= "G", id="ejex")], style={"width":"49.5%","marginRight":"1vw"}),
#             html.Div([html.H2("Estadística 2"), dcc.Dropdown(H, value="Pf", id="ejey")], style={'width':'49.5%'})
...
#         html.Div([html.H1("Estadísticas Top 3 equipos por efectividad"),html.Br(),dcc.Dropdown(L, value = "2021-2022", id ="tabladrop")]),
#         html.Br(),
